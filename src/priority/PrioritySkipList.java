...
//                    if (!(pred.next[bottomLevel].getReference() == succ && pred.next[bottomLevel].isMarked() == false)){
...
//                        if (pred.next[level].compareAndSet(succ, node, false, false))
                        if(pred.next[level].getReference() == succ && pred.next[level].isMarked() == false){
...
//                        if (node.next[level].getReference() == succ){
//                            node.next[level].set(succ,true);
//                        }
                        succ = node.next[level].get(marked);
                    }
                }
...
//                    boolean iMarkedIt = node.next[bottomLevel].compareAndSet(succ, succ, false, true);
                    boolean iMarkedIt = (node.next[bottomLevel].getReference() == succ)
                                         && (node.next[bottomLevel].isMarked() == false) ;
                    if (iMarkedIt){
...
//                        snip = (pred.next[level].getReference() == curr) && (pred.next[level].isMarked() == false);
//                        if (snip){
//                            pred.next[level].set(succ,false);
//                        }
